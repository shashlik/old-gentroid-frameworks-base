...
public final class DisplayManager {
    ...
    private final DisplayManagerLocal mDisplayManager;
    ...
    public DisplayManager(Context context) {
        mContext = context;
        mDisplayManager = DisplayManagerLocal.getInstance();
    }
    ...
    private Display getOrCreateDisplayLocked(int displayId, boolean assumeValid) {
        ...
        if (display == null) {
            display = mDisplayManager.getCompatibleDisplay(displayId,
    ...
    public void stopWifiDisplayScan() {
        mDisplayManager.stopWifiDisplayScan();
    }
    ...
    public void renameWifiDisplay(String deviceAddress, String alias) {
        mDisplayManager.renameWifiDisplay(deviceAddress, alias);
    }
    ...
    public void forgetWifiDisplay(String deviceAddress) {
        mDisplayManager.forgetWifiDisplay(deviceAddress);
    }
    ...
    public WifiDisplayStatus getWifiDisplayStatus() {
        return mDisplayManager.getWifiDisplayStatus();
    }
    ...
    public VirtualDisplay createVirtualDisplay(String name,
        ...
        return mDisplayManager.createVirtualDisplay(mContext,
