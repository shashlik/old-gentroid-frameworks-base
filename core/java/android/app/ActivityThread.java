...
import android.content.pm.PackageManagerLocal;
...
public final class ActivityThread {
    ...
    private ContextLocal mSystemContext;

    static PackageManagerLocal sPackageManager;
    ...
    private class ApplicationThread extends ApplicationThreadNative {
        ...
        public final void bindApplication(String processName,
             ...
             */
            PackageManagerLocal pm = getPackageManager();
        ...
        private void dumpMemInfo(PrintWriter pw, Debug.MemoryInfo memInfo, boolean checkin,
            ...
            long appContextInstanceCount = Debug.countInstancesOfClass(ContextLocal.class);
        ...
        public void dumpGfxInfo(FileDescriptor fd, String[] args) {
            dumpGraphicsInfo(fd);
            WindowManagerLocal.getInstance().dumpGfxInfo(fd);
        }
    ...
    private class Idler implements MessageQueue.IdleHandler {
        ...
        public final boolean queueIdle() {
            ...
            if (a != null) {
                mNewActivities = null;
                IActivityManager am = ActivityManagerLocal.getDefault();
    ...
    public static PackageManagerLocal getPackageManager() {
        if (sPackageManager != null) {
            //Slog.v("PackageManager", "returning cur default = " + sPackageManager);
            return sPackageManager;
        }
        sPackageManager = PackageManagerLocal.getInstance();
        return sPackageManager;
    }
    ...
    public ContextLocal getSystemContext() {
        synchronized (this) {
            if (mSystemContext == null) {
                mSystemContext = ContextLocal.createSystemContext(this);
            }
    ...
    final void scheduleContextCleanup(ContextLocal context, String who,
            String what) {
    ...
    private Context createBaseContextForActivity(ActivityClientRecord r,
        ...
        ContextLocal appContext = ContextLocal.createActivityContext(this, r.packageInfo);
        ...
        if (pkgName != null && !pkgName.isEmpty()
            ...
            DisplayManagerLocal dm = DisplayManagerLocal.getInstance();
    ...
    private void handleLaunchActivity(ActivityClientRecord r, Intent customIntent) {
        ...
        if (a != null) {
            ...
            // manager to stop us.
            try {
                ActivityManagerLocal.getDefault()
    ...
    public void handleRequestAssistContextExtras(RequestAssistContextExtras cmd) {
        ...
        IActivityManager mgr = ActivityManagerLocal.getDefault();
        try {
    ...
    private void handleReceiver(ReceiverData data) {
        ...
        try {
            ...
            ContextLocal context = (ContextLocal)app.getBaseContext();
    ...
    private void handleCreateBackupAgent(CreateBackupAgentData data) {
        ...
        try {
            ...
            try {
                ...
                ContextLocal context = ContextLocal.createAppContext(this, packageInfo);
            ...
            try {
                ActivityManagerLocal.getDefault().backupAgentCreated(packageName, binder);
            } catch (RemoteException e) {
                // nothing to do.
            }
        } catch (Exception e) {
    ...
    private void handleCreateService(CreateServiceData data) {
        ...
        try {
            ...
            try {
                ActivityManagerLocal.getDefault().serviceDoneExecuting(
                        data.token, 0, 0, 0);
            } catch (RemoteException e) {
                // nothing to do.
            }
            ...
            try {
                ...
                try {
                    if (!data.rebind) {
                        ...
                        ActivityManagerLocal.getDefault().publishService(
    ...
    private void handleUnbindService(BindServiceData data) {
        ...
        if (s != null) {
            try {
                ...
                try {
                    if (doRebind) {
                        ActivityManagerLocal.getDefault().unbindFinished(
    ...
    private void handleStopService(IBinder token) {
        ...
        if (s != null) {
            try {
                ...
                if (context instanceof ContextLocal) {
                    final String who = s.getClassName();
                    ((ContextLocal) context).scheduleFinalCleanup(who, "Service");
                }
    ...
    static final void cleanUpPendingRemoveWindows(ActivityClientRecord r) {
        if (r.mPendingRemoveWindow != null) {
            ...
            if (wtoken != null) {
                WindowManagerLocal.getInstance().closeAll(wtoken,
    ...
    final void handleResumeActivity(IBinder token, boolean clearHide, boolean isForward,
        ...
        if (r != null) {
            ...
            if (!willBeVisible) {
                try {
                    willBeVisible = ActivityManagerLocal.getDefault().willActivityBeVisible(
                            a.getActivityToken());
                } catch (RemoteException e) {
                }
            }
            ...
            if (reallyResume) {
                try {
                    ActivityManagerLocal.getDefault().activityResumed(token);
                } catch (RemoteException ex) {
                }
            }
    ...
    private void handlePauseActivity(IBinder token, boolean finished,
        ...
        if (r != null) {
            ...
            try {
                ActivityManagerLocal.getDefault().activityPaused(token);
            } catch (RemoteException ex) {
            }
        }
    }
    ...
    private static class StopInfo implements Runnable {
        ...
        @Override public void run() {
            ...
            try {
                ...
                ActivityManagerLocal.getDefault().activityStopped(
    ...
    private void handleSleeping(IBinder token, boolean sleeping) {
        ...
        if (sleeping) {
            ...
            try {
                ActivityManagerLocal.getDefault().activitySlept(r.token);
            } catch (RemoteException ex) {
            }
        } else {
    ...
    private void handleUpdatePackageCompatibilityInfo(UpdateCompatibilityData data) {
        ...
        WindowManagerLocal.getInstance().reportNewConfiguration(mConfiguration);
    }
    ...
    private void handleDestroyActivity(IBinder token, boolean finishing,
        ...
        if (r != null) {
            ...
            if (r.mPendingRemoveWindow == null) {
                ...
                WindowManagerLocal.getInstance().closeAll(token,
                        r.activity.getClass().getName(), "Activity");
            }
            ...
            if (c instanceof ContextLocal) {
                ((ContextLocal) c).scheduleFinalCleanup(
                        r.activity.getClass().getName(), "Activity");
            }
        }
        if (finishing) {
            try {
                ActivityManagerLocal.getDefault().activityDestroyed(token);
            } catch (RemoteException ex) {
    ...
    private void handleRequestThumbnail(IBinder token) {
        ...
        try {
            ActivityManagerLocal.getDefault().reportThumbnail(
    ...
    final void handleConfigurationChanged(Configuration config, CompatibilityInfo compat) {
        ...
        WindowManagerLocal.getInstance().trimLocalMemory();
    ...
    final void handleTrimMemory(int level) {
        ...
        final WindowManagerLocal windowManager = WindowManagerLocal.getInstance();
    ...
    */
    ...
    private void handleBindApplication(AppBindData data) {
        ...
        final ContextLocal appContext = ContextLocal.createAppContext(this, data.info);
        /*if (!Process.isIsolated()) {
        ...
        if (data.instrumentationName != null) {
            ...
            ContextLocal instrContext = ContextLocal.createAppContext(this, pi);
    ...
    /*package*/ final void finishInstrumentation(int resultCode, Bundle results) {
        ...
        //Slog.i(TAG, "am: " + ActivityManagerLocal.getDefault()
        //      + ", app thr: " + mAppThread);
        try {
    ...
    private void installContentProviders(
        ...
        try {
            ActivityManagerLocal.getDefault().publishContentProviders(
    ...
    public final IContentProvider acquireProvider(
        ...
        try {
            holder = ActivityManagerLocal.getDefault().getContentProvider(
        ...
        if (stable) {
            ...
            if (prc.stableCount == 1) {
                ...
                try {
                    ...
                    ActivityManagerLocal.getDefault().refContentProvider(
    ...
    final void completeRemoveProvider(ProviderRefCount prc) {
        ...
        try {
            if (DEBUG_PROVIDER) {
                Slog.v(TAG, "removeProvider: Invoking ActivityManagerLocal."
                        + "removeContentProvider(" + prc.holder.info.name + ")");
            }
            ActivityManagerLocal.getDefault().removeContentProvider(
    ...
    final void handleUnstableProviderDiedLocked(IBinder provider, boolean fromClient) {
        ...
        if (prc != null) {
            ...
            if (fromClient) {
                ...
                // notification).
                try {
                    ActivityManagerLocal.getDefault().unstableProviderDied(
    ...
    public void attach(boolean system) {
        ...
        if (!system) {
            ...
            try {
                mInstrumentation = new Instrumentation();
                ContextLocal context = ContextLocal.createAppContext(
