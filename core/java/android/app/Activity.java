...
public class Activity extends ContextThemeWrapper
    ...
    private void ensureWindowManager() {
        ...
        mWindowManager = WindowManagerLocal.getInstance();
    }
    ...
    public boolean isImmersive() {
        try {
            return ActivityManagerLocal.getDefault().isImmersive(mToken);
        } catch (RemoteException e) {
            return false;
        }
    }
    ...
    public void convertFromTranslucent() {
        try {
            mTranslucentCallback = null;
            if (ActivityManagerLocal.getDefault().convertFromTranslucent(mToken)) {
                WindowManagerLocal.getInstance().changeCanvasOpacity(mToken, true);
            }
        } catch (RemoteException e) {
            // pass
        }
    ...
    public void convertToTranslucent(TranslucentConversionListener callback) {
        try {
            ...
            mChangeCanvasToTranslucent =
                    ActivityManagerLocal.getDefault().convertToTranslucent(mToken);
        } catch (RemoteException e) {
            // pass
        }
    }
    ...
    void onTranslucentConversionComplete(boolean drawComplete) {
        ...
        if (mChangeCanvasToTranslucent) {
            WindowManagerLocal.getInstance().changeCanvasOpacity(mToken, false);
        }
    }
    ...
    public void setImmersive(boolean i) {
        try {
            ActivityManagerLocal.getDefault().setImmersive(mToken, i);
        } catch (RemoteException e) {
            // pass
        }
    }
    ...
    public boolean shouldUpRecreateTask(Intent targetIntent) {
        try {
            ...
            return !ActivityManagerLocal.getDefault()
    ...
    public boolean navigateUpTo(Intent upIntent) {
        if (mParent == null) {
            ...
            try {
                ...
                return ActivityManagerLocal.getDefault().navigateUpTo(mToken, upIntent,
    ...
    final void performRestart() {
        ...
        if (mStopped) {
            ...
            if (mToken != null && mParent == null) {
                WindowManagerLocal.getInstance().setStoppedState(mToken, false);
            }
    ...
    final void performStop() {
        ...
        if (!mStopped) {
            ...
            if (mToken != null && mParent == null) {
                WindowManagerLocal.getInstance().setStoppedState(mToken, true);
            }
