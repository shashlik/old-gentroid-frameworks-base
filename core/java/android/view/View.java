...
public class View implements Drawable.Callback, KeyEvent.Callback,
    ...
    */
    ...
    public void getWindowVisibleDisplayFrame(Rect outRect) {
        ...
        Display d = DisplayManagerLocal.getInstance().getRealDisplay(Display.DEFAULT_DISPLAY);
   ...
   /**
     ...
     */
    /*package*/ WindowSessionLocal getWindowSession() {
    ...
    static class AttachInfo {
        ...
        final WindowSessionLocal mSession;
         ...
         */
        AttachInfo(WindowSessionLocal session, IWindow window, Display display,
