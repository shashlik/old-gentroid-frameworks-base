...
public abstract class HardwareRenderer {
     ...
     */
    abstract boolean initialize(WaylandWindow window) throws OutOfResourcesException;
     ...
     * @param surface The surface to hardware accelerate
     */
    abstract void updateSurface(WaylandWindow window) throws OutOfResourcesException;
     ...
     * @param surface The surface to hardware accelerate
     */
    abstract void invalidate(WaylandWindow window);
     ...
     * @param window The window to hardware accelerate
     *
     * @return true if the surface was initialized, false otherwise. Returning
     *         false might mean that the surface was already initialized.
     */
    public boolean initializeIfNeeded(int width, int height, WaylandWindow window)
    ...
    static abstract class GlRenderer extends HardwareRenderer {
        ...
        @Override
        boolean initialize(WaylandWindow window) throws OutOfResourcesException {
            if (isRequested() && !isEnabled()) {
                boolean contextCreated = initializeEgl();
                mGl = createEglSurface(window);
                mDestroyed = false;
        ...
        @Override
        void updateSurface(WaylandWindow window) throws OutOfResourcesException {
            if (isRequested() && isEnabled()) {
        ...
        GL createEglSurface(WaylandWindow window) throws OutOfResourcesException {
            // Check preconditions.
            if (sEgl == null) {
        ...
        @Override
        void invalidate(WaylandWindow window) {
        ...
        private boolean createSurface(WaylandWindow window) {
            mEglSurface = sEgl.eglCreateWindowSurface(sEglDisplay, sEglConfig, window, null);
